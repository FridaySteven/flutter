...
class _BetterPlayerMaterialControlsState
  ...
  // My variables
  bool showUpNextPanel = false;
  bool closeUpNextTriggered = false;
  ...
  Widget _buildMainWidget() {
    ...
    // showUpNextPanel = isVideoFinished(_latestValue) && !showUpNextPanel;
    return showUpNextPanel
        ? _upNextPanel()
        : GestureDetector(
            onTap: () {
    ...
    return Row(
      ...
      children: [
        ClipRRect(
          ...
          child: Container(
            constraints:
                const BoxConstraints(maxHeight: 150.0, maxWidth: 160.0),
            child: const Image(
              image: NetworkImage(
        ...
        Flexible(
          child: Padding(
            ...
            child: Column(
              ...
              children: const [
                Text(
                  '浪花兄弟 The Drifters-你是我的OK繃 You\'re My Bandaid「一個人的時候 在陌生的街頭抬頭看著繁星夜垂的天空」【动态歌词】',
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 15,
                    ...
                    Row(
                      ...
                      children: const [
                        Padding(
                          ...
                          child: Text(
                            'Saya amakan bainkjahdkjah aksjdh ...',
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
                              color: Colors.white,
                            ),
